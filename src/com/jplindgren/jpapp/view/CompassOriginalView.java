...
public class CompassOriginalView extends View{
	...
	public CompassOriginalView(Context context) {
		super(context);
		initCompassView();
	}
	public CompassOriginalView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCompassView();
	}
	public CompassOriginalView(Context context, AttributeSet attrs, int defStyle) {
